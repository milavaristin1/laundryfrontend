                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form class="form-group" @submit.prevent="tampil">
                                    ...
                                    <button type="submit" class="btn btn-sn btn-info">Tampilkan</button>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr v-for="(t, index) in transaksi" :key="index">
                                                    ...
                                                    <td v-if="t.tgl_bayar == null">Belum Dibayar</td><td v-else>
...
export default {
    ...
    methods : {
        tampil() {
            this.axios.post('http://localhost/laundry/public/api/report',
                            this.report,
