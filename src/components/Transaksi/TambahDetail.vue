...
export default {
    ...
    created(){
    this.axios.get('http://localhost/laundry/public/api/tampilpaket', {headers : { 'Authorization' : `Bearer` + this.$store.state.token} })
        .then( (res) => {
    ...
    methods : {
    tambah() {
        this.axios.post('http://localhost/laundry/public/api/transaksi/detail',
                        this.detail,
